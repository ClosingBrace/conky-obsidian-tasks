...
// configuration step. It creates a namespace called `conky_obsidian_tasks`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", conky_obsidian_tasks::cmake::project_name, conky_obsidian_tasks::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", conky_obsidian_tasks::cmake::project_version);
      return EXIT_SUCCESS;
    }
